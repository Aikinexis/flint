  ...
  return (
    <>
      <div className="snapshot-modal-backdrop" onClick={handleBackdropClick}>
        <div className="snapshot-modal" role="dialog" aria-modal="true" aria-labelledby="snapshot-modal-title">
          {/* Header */}
          <div className="snapshot-modal-header">
            <div className="snapshot-modal-title-row">
              <div className="snapshot-modal-icon">
          ...
          <div className="snapshot-modal-content">
            <div className="snapshot-modal-text">
              {snapshot.content}
            </div>
          </div>
        </div>
